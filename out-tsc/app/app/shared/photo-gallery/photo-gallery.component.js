...
function PhotoGalleryComponent_p_4_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵclassProp("on-media", ctx_r0.light);
    i0.ɵɵadvance();
...
export class PhotoGalleryComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PhotoGalleryComponent, selectors: [["app-photo-gallery"]], inputs: { title: "title", lead: "lead", items: "items", light: "light" }, decls: 8, vars: 6, consts: [["appReveal", "", 1, "sec-head"], [1, "sec-title", 2, "font-size", "22px"], [1, "sec-rule"], ["class", "sec-lead", "style", "margin:-8px 0 22px", 3, "on-media", 4, "ngIf"], [1, "gal-grid"], ["class", "gal-item", "appReveal", "zoom", 3, "revealDelay", 4, "ngFor", "ngForOf"], ["class", "gal-lightbox", 3, "click", 4, "ngIf"], [1, "sec-lead", 2, "margin", "-8px 0 22px"], ["appReveal", "zoom", 1, "gal-item", 3, "revealDelay"], ["type", "button", 1, "gal-btn", 3, "click"], ["loading", "lazy", "decoding", "async", 1, "gal-img", 3, "src", "alt"], [1, "gal-cap"], [1, "gal-lightbox", 3, "click"], ["type", "button", "aria-label", "\u0E1B\u0E34\u0E14", 1, "gal-close"], [3, "src", "alt"], [1, "gal-lb-cap"]], template: function PhotoGalleryComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 0)(1, "h3", 1);
            i0.ɵɵtext(2);
            i0.ɵɵelementEnd();
            i0.ɵɵelement(3, "div", 2);
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(4, PhotoGalleryComponent_p_4_Template, 2, 3, "p", 3);
            i0.ɵɵelementStart(5, "div", 4);
            i0.ɵɵtemplate(6, PhotoGalleryComponent_figure_6_Template, 5, 7, "figure", 5);
            i0.ɵɵelementEnd();
