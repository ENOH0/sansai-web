...
function CycleFlowComponent_article_1_div_11_ul_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtemplate(1, CycleFlowComponent_article_1_div_11_ul_3_li_1_Template, 2, 1, "li", 15);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function CycleFlowComponent_article_1_div_11_img_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "img", 16);
} if (rf & 2) {
    const s_r5 = i0.ɵɵnextContext(2).$implicit;
    i0.ɵɵproperty("src", s_r5.image, i0.ɵɵsanitizeUrl)("alt", s_r5.title);
} }
function CycleFlowComponent_article_1_div_11_button_5_Template(rf, ctx) { if (rf & 1) {
...
function CycleFlowComponent_article_1_div_11_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(2);
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(3, CycleFlowComponent_article_1_div_11_ul_3_Template, 2, 1, "ul", 12)(4, CycleFlowComponent_article_1_div_11_img_4_Template, 1, 2, "img", 13)(5, CycleFlowComponent_article_1_div_11_button_5_Template, 2, 0, "button", 14);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function CycleFlowComponent_article_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵelementEnd()();
    i0.ɵɵtemplate(11, CycleFlowComponent_article_1_div_11_Template, 6, 5, "div", 10);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
export class CycleFlowComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CycleFlowComponent, selectors: [["app-cycle-flow"]], inputs: { showEvidence: "showEvidence", expandAll: "expandAll", steps: "steps" }, decls: 2, vars: 3, consts: [[1, "cycle"], ["class", "cycle-step", "appReveal", "zoom", 3, "is-open", "revealDelay", 4, "ngFor", "ngForOf"], ["appReveal", "zoom", 1, "cycle-step", 3, "revealDelay"], ["type", "button", 1, "cycle-head", 3, "click", "disabled"], [1, "cycle-no"], [1, "cycle-head-text"], [1, "chip", "cycle-chip"], [1, "cycle-title"], ["width", "30", "height", "30", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2.4", "stroke-linecap", "round", "stroke-linejoin", "round", "aria-hidden", "true", 1, "cycle-chevron"], ["d", "m6 9 6 6 6-6"], ["class", "cycle-detail", 3, "id", 4, "ngIf"], [1, "cycle-detail", 3, "id"], [4, "ngIf"], ["class", "cycle-photo", "loading", "lazy", 3, "src", "alt", 4, "ngIf"], ["type", "button", "class", "cycle-evidence", "title", "\u0E23\u0E2D\u0E41\u0E19\u0E1A\u0E44\u0E1F\u0E25\u0E4C\u0E2B\u0E25\u0E31\u0E01\u0E10\u0E32\u0E19", 4, "ngIf"], [4, "ngFor", "ngForOf"], ["loading", "lazy", 1, "cycle-photo", 3, "src", "alt"], ["type", "button", "title", "\u0E23\u0E2D\u0E41\u0E19\u0E1A\u0E44\u0E1F\u0E25\u0E4C\u0E2B\u0E25\u0E31\u0E01\u0E10\u0E32\u0E19", 1, "cycle-evidence"]], template: function CycleFlowComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 0);
            i0.ɵɵtemplate(1, CycleFlowComponent_article_1_Template, 12, 10, "article", 1);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
