...
export class PagerComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PagerComponent, selectors: [["app-pager"]], inputs: { prevPath: "prevPath", prevName: "prevName", nextPath: "nextPath", nextName: "nextName" }, decls: 5, vars: 4, consts: [["appReveal", "", 1, "pager"], ["class", "pager-link prev", 3, "routerLink", 4, "ngIf"], ["class", "pager-spacer", 4, "ngIf"], ["class", "pager-link next", 3, "routerLink", 4, "ngIf"], [1, "pager-link", "prev", 3, "routerLink"], [1, "pager-name"], [1, "pager-dir"], [1, "pager-spacer"], [1, "pager-link", "next", 3, "routerLink"]], template: function PagerComponent_Template(rf, ctx) { if (rf & 1) {
