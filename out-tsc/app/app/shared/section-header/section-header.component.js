...
export class SectionHeaderComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: SectionHeaderComponent, selectors: [["app-section-header"]], inputs: { kicker: "kicker", num: "num", title: "title", lead: "lead", light: "light" }, decls: 7, vars: 6, consts: [["appReveal", "", 1, "sec-head"], ["class", "sec-kicker", 4, "ngIf"], [1, "sec-title"], ["class", "num", 4, "ngIf"], [1, "sec-rule"], ["class", "sec-lead", 4, "ngIf"], [1, "sec-kicker"], [1, "num"], [1, "sec-lead"]], template: function SectionHeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        } }, dependencies: [CommonModule, i1.NgIf, RevealDirective], styles: ["\n\n\n\n[_nghost-%COMP%] {\n  display: block;\n}\n\n\n\n.on-media[_ngcontent-%COMP%]   .sec-title[_ngcontent-%COMP%] { color: #fff; text-shadow: 0 3px 18px rgba(8, 21, 47, .9); }\n.on-media[_ngcontent-%COMP%]   .sec-kicker[_ngcontent-%COMP%] { color: #fff; font-weight: 800; text-shadow: 0 2px 12px rgba(8, 21, 47, .9); }\n.on-media[_ngcontent-%COMP%]   .sec-lead[_ngcontent-%COMP%] { color: #fff; font-weight: 600; text-shadow: 0 2px 14px rgba(8, 21, 47, .9); }\n.on-media[_ngcontent-%COMP%]   .sec-title[_ngcontent-%COMP%]   .num[_ngcontent-%COMP%] { background: rgba(255, 255, 255, .16); color: #fff; }"] });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SectionHeaderComponent, [{
        type: Component,
        args: [{ selector: 'app-section-header', standalone: true, imports: [CommonModule, RevealDirective], template: "<div class=\"sec-head\" [class.on-media]=\"light\" appReveal>\n  <div class=\"sec-kicker\" *ngIf=\"kicker\">{{ kicker }}</div>\n  <h2 class=\"sec-title\">\n    <span class=\"num\" *ngIf=\"num\">{{ num }}</span>{{ title }}\n  </h2>\n  <div class=\"sec-rule\"></div>\n  <p class=\"sec-lead\" *ngIf=\"lead\">{{ lead }}</p>\n</div>\n", styles: ["/* \u0E2B\u0E31\u0E27\u0E02\u0E49\u0E2D\u0E2B\u0E25\u0E31\u0E01\u0E02\u0E2D\u0E07\u0E41\u0E15\u0E48\u0E25\u0E30\u0E2B\u0E21\u0E27\u0E14\n   \u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38: \u0E04\u0E25\u0E32\u0E2A .sec-* \u0E16\u0E39\u0E01\u0E1B\u0E23\u0E30\u0E01\u0E32\u0E28\u0E44\u0E27\u0E49\u0E17\u0E35\u0E48 src/styles.css \u0E14\u0E49\u0E27\u0E22\n   \u0E40\u0E1E\u0E23\u0E32\u0E30\u0E2B\u0E19\u0E49\u0E32\u0E40\u0E19\u0E37\u0E49\u0E2D\u0E2B\u0E32\u0E1A\u0E32\u0E07\u0E2B\u0E19\u0E49\u0E32\u0E40\u0E23\u0E35\u0E22\u0E01\u0E43\u0E0A\u0E49\u0E42\u0E14\u0E22\u0E15\u0E23\u0E07\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E17\u0E33\u0E2B\u0E31\u0E27\u0E02\u0E49\u0E2D\u0E22\u0E48\u0E2D\u0E22 */\n:host {\n  display: block;\n}\n\n/* \u0E27\u0E32\u0E07\u0E1A\u0E19\u0E1E\u0E37\u0E49\u0E19\u0E20\u0E32\u0E1E\u0E2B\u0E23\u0E37\u0E2D\u0E27\u0E34\u0E14\u0E35\u0E42\u0E2D \u2014 \u0E15\u0E31\u0E27\u0E2B\u0E19\u0E31\u0E07\u0E2A\u0E37\u0E2D\u0E2A\u0E35\u0E02\u0E32\u0E27\u0E1E\u0E23\u0E49\u0E2D\u0E21\u0E40\u0E07\u0E32\u0E43\u0E2B\u0E49\u0E2D\u0E48\u0E32\u0E19\u0E0A\u0E31\u0E14 */\n.on-media .sec-title { color: #fff; text-shadow: 0 3px 18px rgba(8, 21, 47, .9); }\n.on-media .sec-kicker { color: #fff; font-weight: 800; text-shadow: 0 2px 12px rgba(8, 21, 47, .9); }\n.on-media .sec-lead { color: #fff; font-weight: 600; text-shadow: 0 2px 14px rgba(8, 21, 47, .9); }\n.on-media .sec-title .num { background: rgba(255, 255, 255, .16); color: #fff; }\n"] }]
    }], null, { kicker: [{
            type: Input
        }], num: [{
            type: Input
