...
export class OnetChartComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: OnetChartComponent, selectors: [["app-onet-chart"]], inputs: { title: "title", subtitle: "subtitle", note: "note", years: "years", subjects: "subjects", evidenceLabel: "evidenceLabel", evidenceLinks: "evidenceLinks" }, decls: 8, vars: 15, consts: [[1, "onet"], ["role", "tablist", 1, "onet-tabs"], ["type", "button", "role", "tab", 1, "onet-tab", 3, "click"], ["type", "button", "class", "onet-tab", "role", "tab", 3, "is-on", "click", 4, "ngFor", "ngForOf"], [3, "title", "subtitle", "labels", "series", "showValues", "evidenceLabel", "evidenceLinks", "note"], ["class", "onet-diffs", 4, "ngIf"], ["class", "onet-conclusion", 4, "ngIf"], [1, "onet-diffs"], ["class", "onet-diff", 4, "ngFor", "ngForOf"], [1, "onet-diff"], [1, "onet-diff-year"], [1, "onet-diff-main"], [1, "onet-diff-value"], [1, "onet-diff-vs"], [1, "onet-diff-gap"], [1, "onet-conclusion"]], template: function OnetChartComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵadvance();
            i0.ɵɵproperty("title", ctx.title)("subtitle", ctx.chartSubtitle)("labels", ctx.years)("series", ctx.series)("showValues", ctx.selectedIndex !== -1)("evidenceLabel", ctx.evidenceLabel)("evidenceLinks", ctx.evidenceLinks)("note", ctx.note);
            i0.ɵɵadvance();
