...
function MeterListComponent_div_9_Template(rf, ctx) { if (rf & 1) {
...
export class MeterListComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MeterListComponent, selectors: [["app-meter-list"]], inputs: { title: "title", subtitle: "subtitle", note: "note", rows: "rows", max: "max", suffix: "suffix", showEvidence: "showEvidence" }, decls: 10, vars: 5, consts: [["appReveal", "", 1, "chart-card"], [1, "chart-head"], [1, "chart-title"], ["class", "chart-sub", 4, "ngIf"], [1, "meter-body"], ["class", "meter", 4, "ngFor", "ngForOf"], ["class", "chart-note", 4, "ngIf"], ["class", "chart-evidence", 4, "ngIf"], [1, "chart-sub"], [1, "meter"], [1, "meter-head"], [1, "meter-name"], [1, "meter-val"], [1, "meter-track"], [1, "meter-fill"], [1, "chart-note"], [1, "chart-evidence"], ["type", "button", "title", "\u0E23\u0E2D\u0E41\u0E19\u0E1A\u0E44\u0E1F\u0E25\u0E4C\u0E2B\u0E25\u0E31\u0E01\u0E10\u0E32\u0E19"]], template: function MeterListComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(8, MeterListComponent_p_8_Template, 2, 1, "p", 6)(9, MeterListComponent_div_9_Template, 3, 0, "div", 7);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵadvance(4);
